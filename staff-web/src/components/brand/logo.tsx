...
/**
 * HealthcareOS logomark — a rounded "platform tile" whose H crossbar is a
 * heartbeat pulse: reads as the "H" monogram and as health/continuity, without
 * the overused medical cross. Self-contained SVG, themes via the gradient.
 */
...
export function Wordmark({ className }: { className?: string }) {
  return (
    <span className={cn("font-semibold tracking-tight text-ink", className)}>
      Healthcare<span className="text-brand-600 dark:text-brand-400">OS</span>
    </span>
  );
}
