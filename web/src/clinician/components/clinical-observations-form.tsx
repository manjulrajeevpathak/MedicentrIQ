...
} from "@/app/clinician/actions";
import { ConditionChips } from "@clinician/components/condition-chips";
import { VISIT_OUTCOME_OPTIONS, type CodedCondition, type OpdVisit } from "@clinician/lib/types";
import { formatDateTime } from "@clinician/lib/utils";
...
export function ClinicalObservationsForm({ patientId, visit }: { patientId: string; visit: OpdVisit }) {
  ...
  function upload(file: File) {
    startUpload(async () => {
      ...
      fd.set("file", file);
      const { uploadPrescriptionAction } = await import("@/app/clinician/actions");
